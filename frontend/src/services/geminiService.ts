...
const MOCK_GRAPH_NODES = [
  ...
  { id: 'salut', label: 'salut', type: 'vocab', mastery: 0.72, level: 'A1', turn_introduced: 1 },
  { id: 'comment', label: 'comment', type: 'vocab', mastery: 0.52, level: 'A1', turn_introduced: 1 },
  { id: 'oui', label: 'oui', type: 'vocab', mastery: 0.34, level: 'A1', turn_introduced: 1 },
  { id: 'tu_tappelles', label: "tu t'appelles", type: 'sentence', mastery: 0.85, level: 'A1', turn_introduced: 1 },
  { id: 'mon_nom_est', label: 'mon nom est', type: 'sentence', mastery: 0.64, level: 'A1', turn_introduced: 1 },
  { id: 'je_suis', label: 'je suis', type: 'sentence', mastery: 0.67, level: 'A1', turn_introduced: 1 },
  { id: 'je_mappelle', label: "je m'appelle", type: 'sentence', mastery: 0.9, level: 'A1', turn_introduced: 2 },
  { id: 'enchante', label: 'enchanté', type: 'vocab', mastery: 0.32, level: 'A1', turn_introduced: 2 },
  { id: 'tu_habites', label: 'tu habites', type: 'sentence', mastery: 0.8, level: 'A1', turn_introduced: 2 },
  { id: 'dans', label: 'dans', type: 'grammar', mastery: 0.58, level: 'A1', turn_introduced: 2 },
  { id: 'france', label: 'France', type: 'vocab', mastery: 0.55, level: 'A1', turn_introduced: 2 },
  { id: 'jhabite', label: "j'habite", type: 'sentence', mastery: 0.85, level: 'A1', turn_introduced: 3 },
  { id: 'cest', label: "c'est", type: 'grammar', mastery: 0.33, level: 'A1+', turn_introduced: 3 },
  { id: 'tu_aimes', label: 'tu aimes', type: 'sentence', mastery: 0.75, level: 'A1+', turn_introduced: 3 },
  { id: 'paris', label: 'Paris', type: 'vocab', mastery: 0.68, level: 'A1+', turn_introduced: 3 },
  { id: 'ville', label: 'ville', type: 'vocab', mastery: 0.62, level: 'A1+', turn_introduced: 3 },
  { id: 'quartier', label: 'quartier', type: 'vocab', mastery: 0.37, level: 'A1+', turn_introduced: 3 },
  { id: 'faire', label: 'faire', type: 'vocab', mastery: 0.5, level: 'A1+', turn_introduced: 4 },
  { id: 'moi_aussi', label: 'moi aussi', type: 'sentence', mastery: 0.63, level: 'A1+', turn_introduced: 4 },
  { id: 'loisirs', label: 'loisirs', type: 'vocab', mastery: 0.46, level: 'A1+', turn_introduced: 4 },
  { id: 'se_promener', label: 'se promener', type: 'sentence', mastery: 0.36, level: 'A1+', turn_introduced: 4 },
  { id: 'visiter', label: 'visiter', type: 'vocab', mastery: 0.6, level: 'A2', turn_introduced: 5 },
  { id: 'tu_parles', label: 'tu parles', type: 'sentence', mastery: 0.31, level: 'A2', turn_introduced: 5 },
  { id: 'musees', label: 'musées', type: 'vocab', mastery: 0.56, level: 'A2', turn_introduced: 5 },
  { id: 'croissants', label: 'croissants', type: 'vocab', mastery: 0.59, level: 'A2', turn_introduced: 5 },
  { id: 'tres_bien', label: 'très bien', type: 'grammar', mastery: 0.44, level: 'A2', turn_introduced: 5 },
  { id: 'magnifiques', label: 'magnifiques', type: 'vocab', mastery: 0.48, level: 'A2', turn_introduced: 5 },
];

const MOCK_GRAPH_LINKS = [
  { source: 'bonjour', target: 'comment', relationship: 'semantic', turn_introduced: 1 },
  { source: 'bonjour', target: 'salut', relationship: 'semantic', turn_introduced: 1 },
  { source: 'salut', target: 'je_suis', relationship: 'semantic', turn_introduced: 1 },
  { source: 'comment', target: 'tu_tappelles', relationship: 'prerequisite', turn_introduced: 1 },
  { source: 'oui', target: 'tu_tappelles', relationship: 'prerequisite', turn_introduced: 1 },
  { source: 'tu_tappelles', target: 'mon_nom_est', relationship: 'semantic', turn_introduced: 1 },
  { source: 'mon_nom_est', target: 'je_suis', relationship: 'reactivation', turn_introduced: 1 },
  ...
  { source: 'je_mappelle', target: 'tu_habites', relationship: 'reactivation', turn_introduced: 2 },
  { source: 'tu_habites', target: 'dans', relationship: 'prerequisite', turn_introduced: 2 },
  { source: 'dans', target: 'france', relationship: 'semantic', turn_introduced: 2 },
  ...
  { source: 'paris', target: 'ville', relationship: 'semantic', turn_introduced: 3 },
  { source: 'ville', target: 'quartier', relationship: 'semantic', turn_introduced: 3 },
  { source: 'cest', target: 'tu_aimes', relationship: 'prerequisite', turn_introduced: 3 },
  { source: 'tu_aimes', target: 'quartier', relationship: 'reactivation', turn_introduced: 3 },
  { source: 'tu_aimes', target: 'faire', relationship: 'prerequisite', turn_introduced: 4 },
  { source: 'faire', target: 'moi_aussi', relationship: 'semantic', turn_introduced: 4 },
  { source: 'faire', target: 'loisirs', relationship: 'prerequisite', turn_introduced: 4 },
  { source: 'loisirs', target: 'se_promener', relationship: 'semantic', turn_introduced: 4 },
  { source: 'moi_aussi', target: 'tu_aimes', relationship: 'reactivation', turn_introduced: 4 },
  ...
  { source: 'visiter', target: 'croissants', relationship: 'semantic', turn_introduced: 5 },
  { source: 'tu_aimes', target: 'tu_parles', relationship: 'reactivation', turn_introduced: 5 },
  { source: 'tu_parles', target: 'tres_bien', relationship: 'semantic', turn_introduced: 5 },
  { source: 'tres_bien', target: 'magnifiques', relationship: 'prerequisite', turn_introduced: 5 },
  { source: 'musees', target: 'magnifiques', relationship: 'semantic', turn_introduced: 5 },
];
